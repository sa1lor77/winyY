  ...
  function (t, i, e) {
    ...
    function o(t) {
      ...
      (i = void 0 === i.F ? l() : i.F),
        ...
        (this.a.A || this.a.C) &&
          (this.o = new h({ j: this.a.j, f: this.a.f, P: this.a.F })),
        (this.enabled = !0),
        this.K();
    }
    function h(t) {
    ...
    (h.prototype.g = function (t) {
      ...
      (h.prototype.T = function () {
        this.s && this.a.P.removeChild(this.b),
          (this.s = !1),
          d(this.b, this.c);
      }),
      ...
      (o.prototype.l = function () {
        if (this.enabled) {
          ...
          t && "function" == typeof t && t(),
            this.a.m.show(
              this.a.b.getAttribute(this.a.O),
        ...
        (s = l ? d / 2 : 0),
          ...
          this.b.parentElement === this.a.u &&
            ...
            this.a.G &&
              (t < e.left + f
                ? (t = e.left + f)
                : t + n > e.left + e.width + f &&
                  (t = e.left + e.width - n + f),
              i < e.top + l
                ? (i = e.top + l)
                : i + h > e.top + e.height + l &&
                  (i = e.top + e.height - h + l)),
            (this.b.style.left = t + "px"),
            (this.b.style.top = i + "px")),
          this.a.N ||
            (a > s ? (a = s) : a < d && (a = d),
